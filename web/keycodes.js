...
export const KEY_GROUPS = [
    ...
    },
    {
        label: 'Media & volume',
        keys: [
            { code: 0x00ae, label: 'Volume Down' },
            { code: 0x00af, label: 'Volume Up' },
            { code: 0x00b0, label: 'Mute' },
            { code: 0x00b4, label: 'Previous Track' },
            { code: 0x00b5, label: 'Next Track' },
            { code: 0x00cd, label: 'Play / Pause' },
            { code: 0x00b7, label: 'Stop' },
            { code: 0x00b6, label: 'Rewind' },
            { code: 0x00b3, label: 'Fast Forward' },
        ],
    },
    {
        label: 'Symbols',
    ...
    },
    {
        label: 'Mouse',
        keys: [
            { code: 0x00f0, label: 'Mouse Left' },
            { code: 0x00f1, label: 'Mouse Right' },
            { code: 0x00f2, label: 'Mouse Middle' },
            { code: 0x00f3, label: 'Mouse 4' },
            { code: 0x00f4, label: 'Mouse 5' },
            { code: 0x00f5, label: 'Mouse Wheel Up' },
            { code: 0x00f6, label: 'Mouse Wheel Down' },
        ],
    },
];
